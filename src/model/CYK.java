...
public class CYK{
    ...
    protected static boolean isTokenWord = false;
    protected static ArrayList<String> terminals = new ArrayList<String>();
    protected static ArrayList<String> nonTerminals = new ArrayList<String>();
